...
[![CI](https://github.com/qiuyongjun/YJDragGrid/actions/workflows/ci.yml/badge.svg)](https://github.com/qiuyongjun/YJDragGrid/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Release](https://img.shields.io/github/v/release/qiuyongjun/YJDragGrid)](https://github.com/qiuyongjun/YJDragGrid/releases)

A reusable Qt Widgets component for draggable grid layouts.

YJDragGrid provides a custom grid layout and a container widget that supports drag-and-drop reordering, auto-scroll, and configurable column counts. It is built on top of `QLayout` and works with both Qt 5 and Qt 6.
...
Use YJDragGrid directly from source:

```cmake
add_subdirectory(path/to/YJDragGrid)
target_link_libraries(YourApp PRIVATE YJDragGrid::YJDragGrid)
```
...
auto *grid = new YJDragGrid::DragGridWidget(scrollArea, parent);
...
```
.
├── include/YJDragGrid/     # Public headers
